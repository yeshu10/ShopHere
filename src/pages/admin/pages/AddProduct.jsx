        ...
        <div>
            <div className='flex justify-center items-center h-screen bg-gradient-to-r from-pink-100 via-purple-100 to-blue-100'>
                <div className='bg-white px-10 py-10 rounded-xl shadow-lg'>
                    <div>
                        <h1 className='text-center text-pink-600 text-xl mb-4 font-bold'>Add Product</h1>
                    </div>
                    <div>
                        <input type="text"
                    ...
                    <div>
                        <textarea cols="30" rows="10"
                            ...
                            className='bg-pink-200 mb-4 px-2 py-2 w-full lg:w-[20em]  h-20 rounded-lg text-gray-800 placeholder:text-gray-500 outline-none'
