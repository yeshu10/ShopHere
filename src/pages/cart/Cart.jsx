...
import { clearFromCart, deleteFromCart } from '../../redux/cartSlice';
...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_brmxN3tbN6mheJ",
      key_secret: "7fLWEH0ofempXjSCsCcdnsM9",
  ...
  return (
    ...
    <h1 className="text-2xl font-bold text-center flex-grow">Cart Items</h1>
    <button type="button"  onClick={clearCart} className="focus:outline-none text-white bg-violet-600 hover:bg-violet-800 font-medium rounded-lg text-sm px-5 py-2.5">
      Clear Cart
    </button>
</div>
